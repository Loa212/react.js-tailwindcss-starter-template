import logo from './tailwind-css-logo.svg';
import './App.css';
    ...
    <div className="App">
     ...
     <section className="text-gray-600 body-font">
        <div className="container mx-auto flex px-5 py-10 items-center justify-center flex-col">
          <img className="lg:w-2/6 md:w-3/6 w-5/6 mb-16 object-cover object-center rounded" alt="hero" src={logo} />
          <div className="text-center lg:w-2/3 w-full">
            <h1 className="title-font sm:text-4xl text-3xl mb-8 font-medium text-gray-900">Tailwind Starter Template <CheckCircleOutline/></h1>
